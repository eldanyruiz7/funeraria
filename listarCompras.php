				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Listar compras</li>
						</ul><!-- /.breadcrumb -->
						...
						<div class="page-header">
							<h1>
								...
								<small>
									...
									Lista de compras registradas, por rango de fechas
								</small>
							</h1>
						</div><!-- /.page-header -->
						<div class="row">
							...
							<div class="modal-body">
								<form class="form-horizontal" role="form" onSubmit="return false">
									<div class="form-group">
										<label class="col-xs-12 text-left"><i class="fa fa-question-circle" aria-hidden="true"></i> ¿Deseas cancelar esta compra del sistema? <br/> Esta acción no puede deshacerse.<br/>El sistema intentará regresar el inventario a su estado antes de efectuar esta compra.</label>
									</div>
								</form>
...
<![endif]-->
		...
		<script type="text/javascript">
			...
			{
				console.log(d);
				htmlReturn ='<table class="table table-striped table-bordered table-hover" style="width:50%">'+
							'	<th>ID Producto</th>'+
							'	<th>Nombre</th>'+
			...
			$(document).ready(function()
			{
				...
				$(document).on('click','#btnEliminarModal',function()
				{
			        ...
			        {
			            method: "POST",
			            url:"assets/ajax/eliminarCompra.php",
			        ...
			        .done(function(p)
			        {
						...
						if (p.status == 1)
						{
							...
							{
							 	dialog.find('.bootbox-body').html('<i class="fa fa-check" aria-hidden="true"></i> Esta compra ha sido cancelada correctamente');
			...
			jQuery(function($) {
				...
				myTable = $('#dynamic-table').DataTable( {
			        ...
			        "ajax":
					{
						"url":"assets/ajax/listarCompras.JSON.php",
						"type": "GET",
						"data": function(d)
						{
				...
				$(document).on('click', 'td.details-control', function ()
				{
					...
					else
					{
						...
						{
							method: "POST",
							url:"assets/ajax/obtenerRowDet_compra.php",
							dataType:'JSON',
