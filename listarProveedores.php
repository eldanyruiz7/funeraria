				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Listar proveedores</li>
						</ul><!-- /.breadcrumb -->
							...
							<div class="modal-body">
								<form class="form-horizontal" role="form" id="form-editar-cliente" onSubmit="return false">
									...
									<div class="form-group divError">
										...
										<div class="col-sm-9">
											<input type="text" id="inputRsocialEdit" autocomplete="off" name="inputRsocialEdit" placeholder="Razón social" class="form-control">
										</div>
									</div>
									<div class="form-group divError">
										<label class="col-sm-3 control-label no-padding-right"> Representante (*) </label>

										<div class="col-sm-9">
											<input type="text" id="inputRepresentanteEdit" autocomplete="off" name="inputRepresentanteEdit" placeholder="Nombre del representante" class="form-control">
										</div>
									</div>
									<div class="form-group divError">
									...
									<div class="form-group divError">
										...
										<div class="col-sm-9">
											<input type="text" id="inputDomicilio1Edit" autocomplete="off" name="inputDomicilio1Edit" placeholder="Domicilio del proveedor" class="form-control">
										</div>
									</div>
									<div class="form-group divError">
										...
										<div class="col-sm-9">
											<input type="text" id="inputDomicilio2Edit" autocomplete="off" name="inputDomicilio2Edit" placeholder="Domicilio del proveedor" class="form-control">
										</div>
									</div>
									<div class="form-group divError">
		...
		<?php
		 ...
		 ?>
									...
									<div class="form-group divError">
										...
										<div class="col-sm-9">
											<input type="text" id="inputEmailEdit" placeholder="E mail" autocomplete="off" name="inputEmailEdit" class="form-control">
										</div>
									</div>
...
<![endif]-->
		...
		<script type="text/javascript">
			...
			function format ( d ) {
				...
				celular = d.celular;
				email = d.email;
				domicilio = d.domicilio1+" "+d.domicilio2+", "+d.cp+". "+d.estado;
				html = '<div class="col-xs-10">';
				html +='    <div class="table-responsive">';
				html +='       <table class="table table-striped table-bordered table-hover">';
				html +='			<tr>';
				html +='				<td>';
				html +='					<b>Teléfono:</b><br> '+telefono;
				html +='				</td>';
				html +='				<td>';
				html +='					<b>Celular:</b><br> '+celular;
				html +='				</td>';
				html +='				<td>';
				html +='					<b>E mail:</b><br> '+email;
				html +='				</td>';
				html +='				<td>';
				html +='					<b>Domicilio:</b><br> '+domicilio;
				html +='				</td>';
				html +='			</tr>';
				html +='		</table>';
				html +='	</div>';
			...
			$(document).ready(function()
			{
				...
				$(document).on("click",".aEdit", function()
				{
			        ...
			        {
			            method: "POST",
			            url:"assets/ajax/infoProveedor.php",
			        ...
			        .done(function(p)
			        {
						...
						{
							$("#inputRsocialEdit").val(p.rsocial);
							$("#inputRepresentanteEdit").val(p.representante);
				...
				$("#btnEditarProducto").click(function()
				{
			        ...
			        {
			            method: "POST",
			            url:"assets/ajax/editarProveedor.php",
			...
			jQuery(function($) {
				...
				myTable = $('#dynamic-table').DataTable( {
			        ...
			        "ajax":
					{
						"url":"assets/ajax/listarProveedores.JSON.php",
						"complete": function()
						{
