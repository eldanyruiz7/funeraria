<?php
    ...
    else
    {
        ...
        // {
            ...
            // {
            //     if ($prepare_compra->bind_param('i',$idContrato) && $prepare_compra->execute())
            //     {
    ...
    /////////////////////////////////////////////////////////// COMPRA!!! ////////////////////////////////////////////////////////////////
                        ...
                        // $idContrato                   = $row_compra['idCompra'];
                        ...
                        $pdf->Cell(200,8,utf8_decode("CORRIDA FINANCIERA"),$margen,1,'C');
                        ...
                        $pdf->SetFont('Courier','B',10.5);
                        $pdf->Cell(22,5.5,utf8_decode('NOMBRE DEL PLAN:'),$margen,0,'L');
                        $pdf->SetFont('Courier','',9.5);
                        $pdf->Cell(88,5.5,utf8_decode($nombre),1,1,'C',true);
                        $pdf->SetFont('Courier','B',10.5);
                        ...
                        {
                            if ($prepare_det->bind_param('i', $idContrato) && $prepare_det->execute())
                            {
                        ...
                        $pdf->Image('../images/icons/logo.png',7,5,-370);
                        if (!$compraActiva)
                        {
