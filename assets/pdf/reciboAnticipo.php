...
else
{
    ...
    //                                         $nombreUsuario, $apellidopUsuario, $apellidomUsuario, $noDePago) &&
    ...
    //         {
                ...
                $fecha_sql          = $contrato->fechaCreacion;
                $parts              = explode('-',$fecha_sql);
                $listaVentas        = '';
                $contVentas         = 0;
                $reciboNo = "1° aportación";//str_pad($idRecibo, 10, "0", STR_PAD_LEFT);
                $anio = $parts[0];
                ...
                $pdf->Cell(30,10,utf8_decode($reciboNo),0,0,'R',True);
                $pdf->Cell(30,10);
                $pdf->SetFont('Times','I',14);
                $pdf->Cell(50,10,'Bueno por:',0,0,'R');
                $pdf->SetFont('Times','B',14);
                $pdf->Cell(37,10,'$'.number_format($contrato->anticipo,2,".",","),0,0,'R',True);
                $pdf->Ln();
                $pdf->SetFont('Times','I',14);
                $pdf->Cell(40,10,utf8_decode('Recibimos de:'),0,0,'R');
                $pdf->SetFont('Times','B',14);
                $pdf->Cell(125,10,utf8_decode($contrato->nombreCliente),0,0,'C');
                $pdf->Ln();
                $pdf->SetFont('Times','I',14);
                $pdf->Cell(40,10,utf8_decode('La cantidad de:'),0,0,'R');
                $pdf->SetFont('Times','B',11);
                //$cantLetra = num2letras(3000.00);
                $pdf->Cell(145,10,numtoletras($contrato->anticipo),0,0,'C',TRUE);
                $pdf->Ln();
                $pdf->SetFont('Times','I',14);
                $pdf->Cell(40,10,utf8_decode('Por concepto de:'),0,0,'R');
                $pdf->SetFont('Times','',14);
                // $noDePago = $noDePago < 1 ? 1 : $noDePago;
                $pdf->Cell(125,10,utf8_decode('1° Aportación servicio funerario.'),0,1,'C');
                $pdf->SetFont('Times','B',14);
                $pdf->Cell(200,10,utf8_decode("Contrato Número: ".str_pad($contrato->id, 9, "0", STR_PAD_LEFT)),0,0,'C');
                //$pdf->Ln();
                $pdf->Cell(40,10);
                $pdf->SetFont('Times','',14);
                $pdf->Ln();
                ...
                $pdf->Cell(60,10,utf8_decode($contrato->nombreUsuario),0,0,'C');
                ...
                $pdf->Image('../images/avatars/sucursales/'.$contrato->idSucursal.'/logo.jpg',12,73,-290);
