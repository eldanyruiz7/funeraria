<?php
    ...
    else
    {
        ...
        // if (!$telefono = validarFormulario('s',$telefono,0))
        // {
        //     $response['mensaje'] = "El campo teléfono no puede estar en blanco";
        //     $response['status'] = 0;
        //     $response['focus'] = 'telefono';
        //     responder($response, $mysqli);
        // }
        // if (!$celular = validarFormulario('s',$celular,0))
        // {
        //     $response['mensaje'] = "El campo celular no puede estar en blanco";
        //     $response['status'] = 0;
        //     $response['focus'] = 'celular';
        //     responder($response, $mysqli);
        // }
