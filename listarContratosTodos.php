			...
			<div class="main-content">
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							<li class="active"><i class="ace-icon fa fa-file-text home-icon"></i> Contratos</li>
						</ul><!-- /.breadcrumb -->
					</div>
					...
					<div class="page-content">
						<div class="page-header">
							<div class="row">
								<div class="col-xs-11">
									<h1>
										<i class="fa fa-file-text" aria-hidden="true"></i> Lista de contratos
										<small>
											<i class="ace-icon fa fa-angle-double-right"></i>
											Lista de contratos (Sin filtrar)
										</small>
									</h1>
								</div>
							</div>
		...
		<script type="text/javascript">
			...
			$(document).ready(function()
			{
				...
				.DataTable( {
					"ajax":
					{
						"url":"assets/ajax/listarContratos.JSON.php",
						"complete": function()
						{
				...
				$("#modal-aServicio").on('shown.bs.modal', function()
				{
					resetDuallist();
				});
				$("#modal-aServicio").on('hidden.bs.modal', function()
				{
					// resetDuallist();
					$("#inputResponsableDeja").val('');
					$("#inputResponsableRecoje").val('');
					$(".divError-r").removeClass("has-error");
					$(".divError").removeClass("has-error");
					$(".ace-switch-6").prop("checked",false);
					$("#divDuracion").show();
					$("#divRecojen").hide();
					$("#inputNuevoNombre").val('');
					$("#inputNuevoApellidop").val('');
					$("#inputNuevoApellidom").val('');
					$("#inputNuevoPulsera").val('');
					$("#inputNuevoFechaNac").val('');
					$("#inputDuracion").val("1:00");
					$("#inputTelContacto").val("");
					$("#inputTelContacto2").val("");
					$("#textObservaciones").val("");
					$("#inputResponsableRecoje").val("");
					$("#chkMismoResponsable").prop("checked",true);
					$("#selectResponsableDeja").html('<option value="0">No hay sugerencias...</option>')
					$("#selectResponsableRecoje").html('<option value="0">No hay sugerencias...</option>')

				});
				//Reparar error doble modal bootstrap
			});
