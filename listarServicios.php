				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Listar servicios</li>
						</ul><!-- /.breadcrumb -->
							...
							<div class="modal-body">
								<form class="form-horizontal" role="form" id="form-editar-cliente" onSubmit="return false">
									...
									<div class="form-group divError">
										...
										<div class="col-sm-9">
											<input type="text" id="inputNombreEdit" autocomplete="off" name="inputNombreEdit" placeholder="Nombre del servicio" class="form-control">
										</div>
									</div>
									<div class="form-group divError">
										...
										<div class="col-sm-9">
											<input type="text" id="inputDescripcionEdit" autocomplete="off" name="inputDescripcionEdit" placeholder="Descripción" class="form-control">
										</div>
									</div>
									<div class="form-group divError">
										...
										<div class="col-sm-9">
											<input type="number" id="inputPrecioEdit" autocomplete="off" name="inputPrecioEdit" placeholder="Precio" min="0" value="0" class="form-control text-right">
										</div>
									</div>
								</form>
							</div>
		...
		<script type="text/javascript">
			...
			$(document).ready(function()
			{
				...
				$(document).on("click",".aEdit", function()
				{
			        ...
			        {
			            method: "POST",
			            url:"assets/ajax/infoServicio.php",
			        ...
			        .done(function(p)
			        {
						...
						else
						{
							...
							$("#inputDescripcionEdit").val(p.descripcion);
							$("#inputPrecioEdit").val(p.precio);
				...
				$("#btnEditarProducto").click(function()
				{
			        ...
			        {
			            method: "POST",
			            url:"assets/ajax/editarServicio.php",
			...
			jQuery(function($) {
				...
				myTable = $('#dynamic-table').DataTable( {
			        ...
			        "ajax":
					{
						"url":"assets/ajax/listarServicios.JSON.php",
						"complete": function()
						{
				...
				new $.fn.dataTable.Buttons( myTable, {
					buttons: [
					...
					},
					 {
						...
						"className": "btn btn-white btn-primary btn-bold",
						autoPrint: true,
						message: 'Reporte de lista de servicios'
					  }
					]
				} );
