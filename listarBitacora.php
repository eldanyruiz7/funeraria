...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Bit&aacute;cora d eventos</title>
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Listar bit&aacute;cora de eventos</li>
						</ul><!-- /.breadcrumb -->
					...
					<div class="page-content">
						<div class="page-header">
							<h1>
								<i class="fa fa-table" aria-hidden="true"></i> Bit&aacute;cora de eventos
								<small>
									<i class="ace-icon fa fa-angle-double-right"></i>
									Lista de bit&aacute;cora de eventos, por rango de fechas
								</small>
							</h1>
						</div><!-- /.page-header -->
						<div class="row">
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				myTable = $('#dynamic-table').DataTable( {
			        ...
			        "ajax":
					{
						"url":"assets/ajax/listarBitacora.JSON.php",
						"type": "GET",
						"data": function(d)
						{
				...
				new $.fn.dataTable.Buttons( myTable, {
					buttons: [
					...
					},
					 {
						...
						"className": "btn btn-white btn-primary btn-bold",
						autoPrint: true,
						message: 'Reporte de bitácora de eventos'
					  }
					]
				} );
