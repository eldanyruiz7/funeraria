				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						<div class="page-header">
							<h1>
								<i class="fa fa-truck" aria-hidden="true"></i> Agregar proveedor
								<small>
							...
							<div class="col-xs-12">
								<form class="form-horizontal" id="form" role="form">
									<div class="form-group">
										<label class="col-sm-4 control-label no-padding-right"> Razón social(*) </label>

										<div class="col-sm-8">
											<input type="text" id="rsocial" name="rsocial" autocomplete="off" placeholder="Razón social" class="col-xs-5">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-4 control-label no-padding-right"> Representante(*) </label>

										<div class="col-sm-8">
											<input type="text" id="representante" autocomplete="off" name="representante" placeholder="Representante" class="col-xs-5">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" id="telefono" autocomplete="off" name="telefono" placeholder="Teléfono" class="col-xs-5 input-mask-phone">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" id="celular" autocomplete="off" name="celular" placeholder="Teléfono" class="col-xs-5 input-mask-phone">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" id="domicilio1" autocomplete="off" name="domicilio1" placeholder="Domicilio (Calle, No Ext, No Int)" class="col-xs-9">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" id="domicilio2" autocomplete="off" name="domicilio2" placeholder="Domicilio (Colonia, Población, Municipio)" class="col-xs-9">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" id="cp" name="cp" autocomplete="off" placeholder="Código postal" class="col-xs-">
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" id="rfc" name="rfc" autocomplete="off" placeholder="RFC" class="col-xs-3">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" id="email" name="email" autocomplete="off" placeholder="Dirección de correo" class="col-xs-4">
										</div>
									</div>
								</form>
							</div>
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<form class="form-horizontal" role="form" onSubmit="return false">
									<div class="form-group">
										<label class="col-xs-12 text-left"><i class="fa fa-question-circle" aria-hidden="true"></i> ¿Deseas agregar este registro al sistema? <br/>Estás a punto de agregar un nuevo proveedor</label>
									</div>
								</form>
							</div>
				...
				$(document).on('click','#btnGuardarModal',function()
				{
					...
					dialog = bootbox.dialog(
					{
						...
						buttons:
						{
							"proveedores" :
							{
								"label" : '<i class="fa fa-truck" aria-hidden="true"></i> Lista de proveedores',
								"className" : "btn-info btn-white btn-bold btn-round oculto",
								callback: function(result)
								{
									window.location.assign("listarProveedores.php");
								}
							},
							"otro" :
							{
								"label" : '<i class="fa fa-user-plus" aria-hidden="true"></i> Capturar otro proveedor',
								"className" : "btn-default btn-white btn-bold btn-round oculto",
								callback: function(result)
								{
									window.location.assign("agregarProveedor.php");
								}
							},
							"index" :
							{
			        ...
			        {
			            method: "POST",
			            url:"assets/ajax/agregarProveedor.php",
			        ...
			        .done(function(p)
			        {
						...
						if (p.status == 1)
						{
							...
							mensaje('success','Proveedor '+p.mensaje+' ha sido guardado exitosamente<br><h5><a href="listarProveedores.php" class="orange">Lista de proveedores</a></h5>');
						}
						else
						{
