				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Reporte de cobranza</li>
						</ul><!-- /.breadcrumb -->
					...
					<div class="page-content">
						<div class="page-header">
							<h1>
								<i class="fa fa-ticket" aria-hidden="true"></i> Reporte de cobranza
								<small>
									<i class="ace-icon fa fa-angle-double-right"></i>
									Lista de cobros recibidos, por rango de fechas
								</small>
							</h1>
						</div><!-- /.page-header -->
						<div class="row">
							...
							<div class="modal-body">
								<form class="form-horizontal" role="form" onSubmit="return false">
									<div class="form-group">
										<label class="col-xs-12 text-left"><i class="fa fa-question-circle" aria-hidden="true"></i> ¿Deseas cancelar este cobro? <br/> Esta acción no puede deshacerse.</label>
									</div>
								</form>
		...
		<script type="text/javascript">
			...
			$(document).ready(function()
			{
				...
				$(document).on('click','#btnEliminarModal',function()
				{
			        ...
			        {
			            method: "POST",
			            url:"assets/ajax/eliminarCobro.php",
			        ...
			        .done(function(p)
			        {
						...
						if (p.status == 1)
						{
							...
							{
							 	dialog.find('.bootbox-body').html('<i class="fa fa-check" aria-hidden="true"></i> Este cobro ha sido cancelado correctamente');
			...
			jQuery(function($) {
				...
				myTable = $('#dynamic-table').DataTable( {
			        ...
			        "ajax":
					{
						"url":"assets/ajax/listarCobros.JSON.php",
						"type": "GET",
						"data": function(d)
						{
						...
						"complete": function()
						{
							...
							$("#dynamic-table").DataTable().rows().data().each(function(el, index){
							  ...
							  if (!isNaN(el['monto']))
							  {
								  total += parseFloat(el['monto']);
							  }
							});
							$("#spanCobrado").text(total.toFixed(2));
						}
					},
					"processing": 	true,
			        ...
			        "columns":		[
						...
						{
							"data": "monto",
							"className":"text-right blue bigger"
						},
						{
							"data": "status",
